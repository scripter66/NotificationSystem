...
getgenv().notif = {}  -- Création de l'objet global pour notifier
...
function getgenv().notif:Info(content, title)
	createNotification(content or "Uh?", title or "Notification", "Info")
end

function getgenv().notif:Warn(content, title)
	createNotification(content or "Uh?", title or "Warning", "Warn")
end

function getgenv().notif:Error(content, title)
